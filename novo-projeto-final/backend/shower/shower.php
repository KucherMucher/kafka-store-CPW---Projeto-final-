    ...
    <main class="main" style="background-color: <?php echo $corbackground ?>; color: <?php echo $cortexto ?>">
        <div class="row wrap container-fluid" style="width='100vh'">
            <div class="container row h-100">
                <div class="bg-image col-md-5 d-none d-md-block h-100" style="background-image: url('toco-toucan-toucano-cabeça-de-aves-do-parque-das-foz-iguacu-brasil-pa-pássaro-tuco-ramphastos-para-fechar-retrato-no-parques-167759732.webp')" alt="Imagem de um tucano" id="Image">
