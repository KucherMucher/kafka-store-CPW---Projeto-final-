...
<!-- 
idea:
    . same as calendario but disabled - copiar calendario e colar
-->
          ...
          <form method="POST" action="index.php?page=calendario" class="modal-form">
            <div class="event-name border border-2 rounded-2 p-2 mb-3">
              <div class="mb-3">
                ...
                <input type="text" class="form-control disabled" id="event-name" placeholder="Título da Oração" name="eventname" disabled>
              </div>
            </div>
            ...
            <div class="music border border-2 rounded-2 p-2 mb-3">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="music" placeholder="URL de Youtube" name="music" disabled>
              </div> 
            </div>
...
<?php
    ...
    echo '<script>SetEventList('.json_encode($event_list).'); DisabledMode()</script>';
